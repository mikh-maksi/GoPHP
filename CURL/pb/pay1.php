...
$data = '<oper>cmt</oper><wait>20</wait><test>0</test><payment id="'.$id.'"><prop name="b_card_or_acc" value="'.$b_card_or_acc.'" /><prop name="amt" value="'.$amt.'" /><prop name="ccy" value="UAH" /><prop name="details" value="'.$details.'" /></payment>';  
$password= '';
